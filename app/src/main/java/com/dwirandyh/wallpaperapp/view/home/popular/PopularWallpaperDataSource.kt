...
class PopularWallpaperDataSource(
    ...
    override fun loadInitial(params: LoadInitialParams<Long>, callback: LoadInitialCallback<Long, Wallpaper>) {
        val wallpaperDisposable = wallpaperRepository.getPopularWallpaper(1)
    ...
    override fun loadAfter(params: LoadParams<Long>, callback: LoadCallback<Long, Wallpaper>) {
        val wallpaperDisposable = wallpaperRepository.getPopularWallpaper((params.key).toInt())
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(
                {
